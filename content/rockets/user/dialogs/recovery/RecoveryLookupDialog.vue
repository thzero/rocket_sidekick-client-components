...
import { useRocketLookupDialogValidation } from '@/components/content/rockets/user/dialogs/recovery/recoveryLookupDialogValidation';
...
export default {
	...
	validations () {
		return Object.assign(LibraryCommonUtility.cloneDeep(useRocketEditValidation(false), LibraryCommonUtility.cloneDeep(useRocketLookupDialogValidation)));
	}
};
</script>
