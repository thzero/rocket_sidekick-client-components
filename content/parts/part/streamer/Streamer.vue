...
import { useStreamerPartValidation } from '@/components/content/parts/part/streamer/streamerPartValidation';
...
export default {
	...
	setup (props, context, options) {
		const {
			...
			scope,
			validation
		} = useStreamerPartComponent(props, context, options);
	...
	validations () {
		...
		LibraryCommonUtility.cloneDeep(useStreamerPartValidation));
	}
};
</script>
